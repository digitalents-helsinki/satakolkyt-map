export const en = {
  message: {
    ...
    trash_left:
      'Did you leave trash sacks on the shore which should be removed?',
    ...
    foreign_species_detail1:
      'You can describe your sightings more specifically',
    foreign_species_detail2:
      'Where specifically did you see them and how much?',
    next: 'Next',
    previous: 'Previous',
    photo: 'Photo',
    clean_additional_info: 'Additional information',
    clean_additional_info_sub: 'Filling additional information is optional',
    clean_something_else: 'Something else you want to tell?',
    send: 'Send',
